  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-20">
      <div className="text-center">
        <p className="eyebrow mb-3">Masaüstü Uygulaması · BYOK · Pro üyelik</p>
        <h1 className="font-display text-4xl leading-tight text-ink md:text-5xl">
          Veriniz cihazınızda kalsın
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-[15px] leading-relaxed text-ink-muted">
          Masaüstü uygulaması kendi Anthropic API anahtarınızla (BYOK) çalışır; tüm doküman
          üretimi yereldedir. Pro ve Kurumsal üyelere özeldir.
        </p>
      </div>
