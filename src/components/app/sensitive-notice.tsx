...
export function SensitiveNotice() {
  return (
    <div role="status" className="animate-fade-in mt-4 flex items-start gap-2.5 rounded-[var(--radius)] border border-warning/40 border-l-2 border-l-warning bg-warning-soft px-4 py-3 text-[13px] leading-relaxed text-warning">
